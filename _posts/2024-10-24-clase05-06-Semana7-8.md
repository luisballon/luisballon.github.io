...
![alt text](/assets/images/estructura_memoria.jpg)
...
![alt text](/assets/images/gcc-g-o-test.jpg)
_Figura. resultados gcc -g -o test test.c y ls -lh._
...
```
![alt text](/assets/images/gdb_test.jpg)
_Figura. gdb test._
_Antes realizar update y tener instalado gdb y gdb-minimal_
...
![alt text](/assets/images/gdb_break-main.jpg)
_Figura. gdb break main._
...
gs_base        0x0                 0
```
![alt text](/assets/images/gdb_info-registers.jpg)
_Figura. gdb info registers._
